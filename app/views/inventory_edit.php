                                            ...
                                            <?php endforeach; ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="assignment_date" name="assignment_date" 
                                                           ...
                                                           <?php echo (!$hardware['client_id'] && !$hardware['current_user_id']) ? '' : 'disabled'; ?>>
                                                ...
                                                <div class="col-12 mt-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="register_assignment" name="register_assignment" value="1" 
                                                               <?php echo (!$hardware['client_id'] && !$hardware['current_user_id']) ? 'checked' : ''; ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateAssignmentFields() {
        ...
        // Si se está registrando una nueva asignación y se selecciona un usuario
