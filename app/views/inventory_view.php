                    ...
                    <div class="card-header bg-primary text-white">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-end">
                                ...
                                <a href="?page=add_hardware" class="btn btn-sm btn-success me-2">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if(isset($record['assignment_notes']) && trim($record['assignment_notes']) !== ''): ?>
                                                                    <button type="button" class="btn btn-sm btn-info" data-bs-toggle="popover" title="Notas" data-bs-content="<?php echo htmlspecialchars($record['assignment_notes']); ?>">
